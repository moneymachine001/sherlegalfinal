...
var	tpj = jQuery;
	...
	RS_MODULES.modules["revslider11"] = {once: RS_MODULES.modules["revslider11"]!==undefined ? RS_MODULES.modules["revslider11"].once : undefined, init:function() {
		...
		revapi1.revolutionInit({
				...
				gridheight:"940,770,640,550",
				perspective:600,
				perspectiveType:"global",
				editorheight:"940,770,640,550",
...
RS_MODULES.modules["revslider22"] = {once: RS_MODULES.modules["revslider22"]!==undefined ? RS_MODULES.modules["revslider22"].once : undefined, init:function() {
    ...
    revapi2.revolutionInit({
            ...
            gridheight:"930,770,640,450",
            perspective:600,
            perspectiveType:"global",
            editorheight:"930,770,640,450",
            responsiveLevels:"1240,1024,778,480",
            progressBar:{disableProgressBar:true},
            navigation: {
                onHoverStop:false
...
var	tpj = jQuery;
	if(window.RS_MODULES === undefined) window.RS_MODULES = {};
	if(RS_MODULES.modules === undefined) RS_MODULES.modules = {};
	RS_MODULES.modules["revslider33"] = {once: RS_MODULES.modules["revslider33"]!==undefined ? RS_MODULES.modules["revslider11"].once : undefined, init:function() {
		...
		revapi3.revolutionInit({
				...
				visibilityLevels:"1240,1024,778,480",
				gridwidth:"1270,1024,778,480",
				gridheight:"815,770,640,450",
				perspective:600,
				perspectiveType:"global",
				editorheight:"815,770,640,450",
				responsiveLevels:"1240,1024,778,480",
				progressBar:{disableProgressBar:true},
				navigation: {
					wheelCallDelay:1000,
...
/* Slider 04 */
	...
	if(window.RS_MODULES === undefined) window.RS_MODULES = {};
	if(RS_MODULES.modules === undefined) RS_MODULES.modules = {};
	RS_MODULES.modules["revslider44"] = {once: RS_MODULES.modules["revslider44"]!==undefined ? RS_MODULES.modules["revslider11"].once : undefined, init:function() {
		...
		revapi4.revolutionInit({
				...
				visibilityLevels:"1240,1024,778,480",
				gridwidth:"1270,1024,778,480",
				gridheight:"930,770,680,500",
				perspective:600,
				perspectiveType:"global",
				editorheight:"930,770,680,500",
				responsiveLevels:"1240,1024,778,480",
				progressBar:{disableProgressBar:true},
				navigation: {
					wheelCallDelay:1000,
